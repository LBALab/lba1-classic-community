...
void InitHoloDatas()
{
	...
	PtrAlt = Screen + SIZE_TEXT_GLOBE + SIZE_COOR_GLOBE;
	PtrMap = Screen + SIZE_TEXT_GLOBE + SIZE_COOR_GLOBE + SIZE_MAP_ALT;
	PtrHoloBody = Screen + SIZE_TEXT_GLOBE + SIZE_COOR_GLOBE + SIZE_MAP_ALT + 65536;
